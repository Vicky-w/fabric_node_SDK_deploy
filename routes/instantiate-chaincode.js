...
var fs = require('fs');
var logger = require('log4js').getLogger("instantiate - chaincode");
...
var instantiate_chaincode = function (req, res) {
    var tx_id = null;
    ...
    Promise.resolve().then(() => {
        ...
        targets.push(peer);
        logger.info(' create new eventhub %s', userConfig[config_peer].event_url);
        ...
        logger.info("*************************************** instantiate_chaincode end *************************************");
...
module.exports = instantiate_chaincode;